...
export const blogArticles: Article[] = [
  ...
  },
  {
    ...
    faq: [
      { question: "O que são ETFs?", answer: "ETFs (Exchange Traded Funds) são fundos de índice negociados em bolsa. Eles replicam um índice de referência (como o Ibovespa) e permitem investir em uma cesta diversificada de ativos com uma única cota." },
      { question: "Qual a vantagem do ETF?", answer: "As principais vantagens são a diversificação automática e o baixo custo. Com uma única cota, você investe em todas as empresas de um índice, e as taxas de administração são muito menores que as de fundos de investimento tradicionais." },
      { question: "ETF paga dividendo?", answer: "A maioria dos ETFs no Brasil não distribui dividendos diretamente aos cotistas — eles são reinvestidos automaticamente no próprio fundo, o que aumenta o valor da cota. Existem alguns ETFs específicos de dividendos, mas o reinvestimento é o padrão." },
      { question: "Qual a diferença entre ETF e FII?", answer: "ETFs replicam índices de mercado (ações, renda fixa, etc.), focando em crescimento de capital. FIIs investem em imóveis ou títulos imobiliários e focam em distribuir renda mensal (aluguéis)." },
      { question: "ETF tem Imposto de Renda?", answer: "Sim. Para ETFs de ações, o ganho de capital na venda é tributado em 15%, sem a isenção de R$ 20 mil mensais que existe para ações. ETFs de renda fixa seguem a tabela regressiva de IR." }
    ],
    seoTitle: 'O que são ETFs: Guia Completo para Investir em Fundos de Índice',
    seoDescription: 'Aprenda o que são ETFs (Fundos de Índice), como funcionam, os principais tipos (BOVA11, IVVB11), custos, vantagens e como começar a investir com diversificação e baixo custo.',
    category: 'renda-variavel',
    subcategory: 'etfs',
    pillar: 'pillar-3-renda-variavel',
    cluster: 'etfs',
    tags: ["o que é etf", "etf", "bova11", "ivvb11", "fundos de índice", "investir em etf"],
