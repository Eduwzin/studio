...
export const blogArticles: Article[] = [
  ...
  faq: [
      ...
      { "question": "Devo investir ou quitar dívidas primeiro?", "answer": "Dívidas com juros acima de 1% ao mês (cartão de crédito, cheque especial) devem ser quitadas antes de investir — os juros são maiores que qualquer rendimento de investimento conservador. Para dívidas de juros baixos (financiamento imobiliário), você pode investir e pagar simultaneamente." },
...
Cole no Gemini assim:
```
Adicione o artigo com slug "guia-educacao-financeira" no arquivo src/lib/content.ts usando os dados deste JSON:
[cola o JSON acima]
```