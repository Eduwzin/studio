...
export const blogArticles: Article[] = [
  ...
  },
  {
    ...
    content: [{type: 'html', content: "<h1>CDB ou LCI: quando a isenção de IR realmente compensa?</h1><div class='resumo-rapido'><ul><li>LCI é isenta de IR para pessoa física — CDB tem IR de 15% a 22,5%</li><li>Isenção não garante que LCI rende mais: depende da taxa oferecida e do prazo</li><li>A comparação correta é sempre pelo rendimento líquido — não pela taxa bruta</li><li>LCI tem carência mínima de 90 dias — CDB pode ter liquidez diária</li><li>Use a tabela de equivalência abaixo para decidir em segundos</li></ul></div><p>A dúvida entre CDB e LCI é uma das mais comuns em renda fixa. A maioria das pessoas assume que LCI é sempre melhor por ser isenta de IR — mas isso não é verdade.</p><p>A isenção de IR é uma vantagem real, mas o que determina qual produto rende mais é a taxa oferecida em relação ao CDI. Uma LCI a 85% do CDI pode render menos no líquido do que um CDB a 110% do CDI no mesmo prazo.</p>"}],
  ...
  },
  {
    ...
    content: [{type: 'html', content: "<h1>Melhores investimentos para iniciantes: opções seguras, rentáveis e acessíveis</h1><div class='resumo-rapido'><ul><li>Para iniciantes, segurança e liquidez vêm antes de rentabilidade máxima</li><li>Os melhores pontos de partida são Tesouro Selic, CDB de liquidez diária e LCI/LCA</li><li>Poupança não é recomendada — existem opções mais seguras com rendimento maior</li><li>Antes de escolher qualquer produto, monte a reserva de emergência</li><li>Sempre compare rendimento líquido — não taxa bruta</li></ul></div><p>Uma das perguntas mais comuns de quem está começando a investir é: qual é o melhor investimento para mim? A resposta honesta é que não existe um único produto ideal — existe o produto certo para o seu objetivo, prazo e perfil.</p><p>Mas existe uma lógica clara para iniciantes: comece com produtos simples, seguros e com boa liquidez. Ganhe experiência. Depois evolua para produtos mais complexos.</p>"}],
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "Em juros simples, os juros sempre incidem sobre o capital inicial. Em juros compostos, os juros de cada período são somados ao saldo e geram novos juros. No longo prazo, a diferença é enorme — juros compostos crescem exponencialmente."
      },
      {
  ...
  },
  {
    ...
    content: [{type: 'html', content: "<h1>O que são ETFs: como funcionam, tipos e como investir com diversificação automática</h1><div class='resumo-rapido'><ul><li>ETF é um fundo de índice negociado na bolsa — ele replica uma carteira diversificada de ativos</li><li>Com uma única cota, você investe em dezenas ou centenas de empresas ao mesmo tempo</li><li>Têm taxa de administração baixa — geralmente entre 0,05% e 0,5% ao ano</li><li>São renda variável — o preço oscila conforme o índice que replicam</li><li>Ideais para quem quer diversificação sem precisar escolher ações individualmente</li></ul></div><p>ETF é uma das formas mais eficientes de investir em renda variável com diversificação automática e custo baixo. Em vez de escolher ações individuais, você compra uma cota que já representa dezenas ou centenas de empresas de uma vez.</p><p>Este guia explica o que são, como funcionam, quais os tipos disponíveis no Brasil e como começar.</p>"}],
