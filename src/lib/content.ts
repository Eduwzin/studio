...
export const blogArticles: Article[] = [
  ...
  },
  {
    ...
    description: 'Aprenda tudo sobre renda fixa, dos produtos mais seguros aos mais rentáveis. Entenda CDB, Tesouro Direto, LCI, LCA e como montar sua carteira.',
    seoTitle: 'Guia Completo de Renda Fixa para Iniciantes 2026',
    seoDescription: 'O que é renda fixa? Aprenda tudo sobre os principais investimentos: Tesouro Direto, CDB, LCI, LCA. Veja comparativos, riscos e como começar.',
    date: '2026-03-20',
    ...
    faq: [
      { question: "O que é renda fixa?", answer: "É uma categoria de investimentos onde a forma de cálculo da remuneração (juros) é definida no momento da aplicação. É considerada mais segura e previsível que a renda variável." },
      { question: "Qual o investimento mais seguro do Brasil?", answer: "Os títulos do Tesouro Direto, especialmente o Tesouro Selic, são considerados os investimentos mais seguros do país, pois são garantidos pelo Governo Federal." },
      { question: "CDB, LCI e LCA são seguros?", answer: "Sim, para valores de até R$ 250.000 por CPF e por instituição financeira, eles são garantidos pelo Fundo Garantidor de Créditos (FGC), o que os torna muito seguros." },
      { question: "Qual a melhor renda fixa para iniciantes?", answer: "O Tesouro Selic e os CDBs com liquidez diária que rendem pelo menos 100% do CDI são as melhores opções para começar, pois combinam segurança, liquidez e boa rentabilidade." },
      { question: "Renda fixa pode ter rendimento negativo?", answer: "Em títulos pós-fixados (CDI, Selic), é praticamente impossível. Em títulos prefixados e atrelados à inflação, se você vender antes do vencimento, pode haver prejuízo devido à marcação a mercado. Mas se levar até o vencimento, a rentabilidade contratada é garantida." }
    ],
    category: 'renda-fixa',
    subcategory: 'guia',
    pillar: 'pillar-2-renda-fixa',
    cluster: 'fundamentos-renda-fixa',
    tags: ["guia renda fixa", "o que é renda fixa", "investimentos renda fixa", "cdb", "tesouro direto", "lci", "lca"],
    disclaimer: defaultDisclaimer,
  },
  {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "Os dois são excelentes para reserva de emergência e primeiro investimento. O Tesouro Selic é garantido pelo Governo Federal (sem limite). O CDB tem cobertura do FGC até R$ 250.000 por instituição. Para valores abaixo desse valor, os dois são equivalentes em segurança."
      },
      {
        question: "Devo começar pela renda fixa ou renda variável?",
        answer: "Renda fixa. Monte a reserva de emergência, entenda como os investimentos funcionam e só então explore renda variável com uma parcela pequena do seu patrimônio. Renda variável exige horizonte de tempo longo e tolerância a oscilações."
      },
      {
