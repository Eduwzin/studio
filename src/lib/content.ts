...
export const blogArticles: Article[] = [
  ...
  },
  {
    ...
    conclusion: `<h2>Conclusão</h2><p>R$ 1.000 no CDB a 100% do CDI rende mais que o dobro da poupança em qualquer prazo com a Selic atual de {{selicRate}}% ao ano.</p><p>Para começar, escolha um CDB com a maior taxa disponível dentro do seu prazo, respeite a carência e mantenha o rendimento acumulando.</p><p>Quer entender melhor o CDB? <a href='/o-que-e-cdb'>Leia o guia completo sobre o CDB.</a> Ou <a href='/cdb-ou-poupanca'>veja a comparação completa entre CDB e poupança.</a></p><p><em>Referência: CDI de {{cdiRate}}% ao ano (Bacen/SGS, {{dataAtualizacao}}). Simulações com taxa constante para fins ilustrativos.</em></p>`,
