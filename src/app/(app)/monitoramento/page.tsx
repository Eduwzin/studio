...
// Objeto simulando os dados macroeconômicos que seriam coletados diariamente
const simulatedMacroContext = {
  selicRate: 10.5,
  ...
  const handleAnalyzeClick = async () => {
    ...
    try {
      const result = await monitorPortfolio({
        ...
        macroContext: simulatedMacroContext,
      });
      setAnalysis(result);
    } catch (err) {
      console.error(err);
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <Card className="text-center">
        <CardHeader>
            ...
            <CardDescription>Clique no botão abaixo para que nossa IA analise os dados mais recentes do mercado e forneça os próximos passos ideais para o seu perfil.</CardDescription>
        </CardHeader>
        <CardContent>
            {isLoadingProfile ? (
                 <Button disabled>
